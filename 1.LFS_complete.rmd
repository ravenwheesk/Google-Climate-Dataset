...
##          (THWNSA_wide province j industry i) * 
##          (THWSF_CAN_wide Canada industry i) / 
...
THWSF_CAN_extend <- THWSF_CAN_extend %>% select(-contains("Date"))

THWSF_CAN_extend <- THWSF_CAN_wide %>% select(contains("Canada"))
...
THWSA_Canada <- THWSA_Canada %>% select(-contains("Date"))
THWSA_Canada <- THWSA_Canada %>% select(contains("Canada"))
